...
sudo curl https://raw.githubusercontent.com/eldzejgm/pterodactyl-all-in-one-installer/main/resources/themes/SyncTheme/synctheme.tar.gz | sudo tar -xz
#clear
cd /var/www/pterodactyl
